    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <form id="FormTambah" method="post" enctype="multipart/form-data" action="<?= site_url('kategori/ubah') ?>" class="form-horizontal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input type="text" name="nama_kategori" class="form-control" value="<?= $kategori->nama ?>">
